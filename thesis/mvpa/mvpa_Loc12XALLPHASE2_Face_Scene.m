...
function [ results ] = mvpa_Loc12XALLPHASE2_Face_Scene( subject, class_args )
    ...
    for maskIdx = whichMasks % 1:length(maskfn);
     ...
     outfile = sprintf('%s/Loc12Shift%d_%dTRsXALLPHASE2_subject%d_%s_%s_%s.mat', outfold, loc2_shiftTRs, loc2_numTRs, subject, class_args.train_funct_name, class_args.test_funct_name, processed_params) ;
